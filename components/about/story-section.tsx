        ...
        <div className="grid gap-10 md:grid-cols-2 md:items-center">
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              ...
              <li className="flex gap-2">
                <span className="mt-1 size-2 rounded-full bg-emerald-600" /> Proactive refills and delivery options
              </li>
              <li className="flex gap-2">
          ...
          <div className="aspect-[4/3] rounded-2xl bg-white shadow-sm p-4">
            <div
              className="h-full w-full rounded-xl bg-[url('/placeholder.svg?height=540&width=720')] bg-cover bg-center"
              aria-hidden
            />
          </div>
        </div>
